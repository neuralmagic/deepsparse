...
def test_dep_inj_scoped_per_pipeline():
    """
    Test that each pipeline has its own scope for dependency injector
    Pipeline must be instantiated and then called before calling any 
    downstream pipeline
    """
