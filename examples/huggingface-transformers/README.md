...
This directory contains examples of benchmarking, and serving inferences
of Hugging Face transformers from the [hugging-face-transformers](https://github.com/huggingface/transformers)
