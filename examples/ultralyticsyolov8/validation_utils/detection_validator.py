...
class DeepSparseValidator(BaseValidator):
    ...
    def __init__(self, pipeline, dataloader=None, save_dir=None, pbar=None, logger=None, args=None):
        """
    ...
    def __call__(self, stride, classes, model = None):
        """
        ...
        for batch_i, batch in enumerate(bar):
            ...
            # inference
            with dt:
                outputs = self.pipeline(images=[x.cpu().numpy() for x in batch["img"]],
