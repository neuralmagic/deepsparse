...
Currently, the SparseZoo contains 20 BERT models, and the `big-config.yaml` file contains the full list in case you want to load them all 🤯. To load all 20 models at once into memory, make sure you have 16GB of RAM available, otherwise you will get out of memory errors.
