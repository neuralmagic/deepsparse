...
class SparseMaker:
    ...
    def nuke_endpoint(self):
        ...
        self.sm_boto3.delete_endpoint_config(EndpointConfigName=self.endpoint_config_name)
...
if __name__ == "__main__":
        ...
        Sage = SparseMaker(
            ...
            config_name         = "QuestionAnsweringExampleConfig",  # ^[a-zA-Z0-9](-*[a-zA-Z0-9]){0,62}
            endpoint_name       = "question-answering-example-endpoint",
            role_arn            = "arn:aws:iam::831168642639:role/ricky",
        )
