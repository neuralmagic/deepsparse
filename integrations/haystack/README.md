...
The relevant features added as a part of the Haystack information retrieval integration are a [Haystack pipeline](https://github.com/neuralmagic/sparseml/tree/main/src/deepsparse/transformers/haystack/pipeline.py), an [embedding extraction pipeline](https://github.com/neuralmagic/sparseml/tree/main/src/deepsparse/transformers/pipelines/embedding_extraction.py), and two classes, [DeepSparseEmbeddingRetriever](https://github.com/neuralmagic/sparseml/tree/main/src/deepsparse/transformers/haystack/nodes.py) and [DeepSparseDensePassageRetriever](https://github.com/neuralmagic/sparseml/tree/main/src/deepsparse/transformers/haystack/nodes.py).
