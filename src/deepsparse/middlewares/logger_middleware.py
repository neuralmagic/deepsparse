...
from typing import Any, Dict, Iterable, Generator, Tuple, List, get_type_hints
import numpy
...
NAME_KEY = "name"
SCALAR_TYPES_TUPLE = (int, float, bool, str,)
    ...
    def __call__(self, *args, **kwargs) -> Any:
        ...
        if inference_state and hasattr(inference_state, "logger"):
            ...
            for capture, value in unravel_value_as_generator(rtn, tag):   
                logger.log(value=value, tag=tag, capture=capture)

            return rtn
        return self.call_next(*args, **kwargs)

UNRAVEL_VALUUE_AS_GENERATOR_RESOLVERS_MAP = {
    
}
def unravel_value_as_generator(value: Any, capture: str = "") -> Generator[Tuple[str, Any], None, None]:
    ...
    if isinstance(value, Dict):
        ...
        # scalars: (int, float, bool, str) and None
        yield (capture, value)
