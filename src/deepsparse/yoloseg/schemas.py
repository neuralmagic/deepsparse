...
"""
Input/Output Schemas for Image Segmentation with YOLOv5
"""
...
_YOLOImageOutput = namedtuple(
    "_YOLOImageOutput", ["classes", "scores", "boxes", "masks"]
)


class YOLOInputSchema(ComputerVisionSchema):
    """
    Input Model for YOLOv5
    """
...
class YOLOOutputSchema(BaseModel):
    """
    Output Model for YOLOv5
    """
