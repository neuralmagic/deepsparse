...
from deepsparse.yoloseg.schemas import YOLOInputSchema, YOLOOutputSchema
from deepsparse.yoloseg.utils import decode, detect, postprocess, preprocess_array
from deepsparse.yoloseg.utils import COCO_CLASSES
...
class YOLOSegPipeline(Pipeline):
    """
  YOLO Segmentation Pipeline for DeepSparse
