...
"""
Implementation of the Function Logger that applies functions to raw log values
"""
...
class FunctionLogger(BaseLogger):
    """
    Python logger that applies functions to raw log values
    ...
    def _log_data(
        ...
        # filter the loggers if config specifies so
