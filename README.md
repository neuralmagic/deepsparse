...
We are pleased to announce support for LLMs, starting with MPT-7B. DeepSparse is optimized for performant text generation with:
- Custom sparse quantized CPU kernels
