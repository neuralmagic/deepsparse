...
Because the DeepSparse Engine is proprietary, code contributions cannot be made. However, there are options to contribute code. Review [Developing the DeepSparse Engine](DEVELOPING.md) to get started.
